...
cp packaging/appicon.png "$STAGE/usr/share/pixmaps/print-it.png"
cp packaging/linux/print-it.desktop "$STAGE/usr/share/applications/"
cp packaging/linux/print-it-autostart.desktop "$STAGE/etc/xdg/autostart/print-it.desktop"
